...
#endif
static const char *ng0 = "E:/COexcercise/p4/P4/ALU.v";
...
LAB20:    t431 = (t0 + 3512);
    ...
    t435 = *((char **)t434);
    memcpy(t435, t3, 8);
    xsi_driver_vfirst_trans(t431, 0, 31);
    t436 = (t0 + 3416);
    *((int *)t436) = 1;
...
LAB143:    if (*((unsigned int *)t409) < *((unsigned int *)t410))
        goto LAB141;
...
LAB153:    if (*((unsigned int *)t408) > 0)
        goto LAB154;

LAB155:    memcpy(t407, t430, 8);
...
LAB141:    *((unsigned int *)t411) = 1;
    goto LAB142;

LAB144:    *((unsigned int *)t408) = 1;
    goto LAB147;
...
LAB148:    t425 = ((char*)((ng2)));
    goto LAB149;

LAB150:    t430 = ((char*)((ng1)));
    goto LAB151;

LAB152:    xsi_vlog_unsigned_bit_combine(t407, 32, t425, 32, t430, 32);
    goto LAB156;

LAB154:    memcpy(t407, t425, 8);
    goto LAB156;
...
extern void work_m_00000000002809407565_0886308060_init()
{
	static char *pe[] = {(void *)Cont_28_0,(void *)Cont_36_1};
	xsi_register_didat("work_m_00000000002809407565_0886308060", "isim/mipstb_isim_beh.exe.sim/work/m_00000000002809407565_0886308060.didat");
